        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-6">
                <div class="shadow p-5 mb-5 bg-body rounded">
                    ...
                    <form action="adminreset" onsubmit= "return validation()" method="post">
                        <div class = "form-group">
                            ...
                            <div class="form-group mt-3">
                               ...
                               <div>
                                <input type="password" style="width: 90%; border: 0; outline: 0; border-bottom: 2px solid #474747;" name="newPassword" autocomplete="current-password" required="" id="id_password">
