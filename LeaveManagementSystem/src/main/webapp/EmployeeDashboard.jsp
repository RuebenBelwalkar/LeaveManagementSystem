    ...
    <nav class="navbar navbar-expand-lg" style="background-color: rgba(0, 0, 0, 0.2);">
        <div class="container-fluid">
            ...
            <div class="col-8">
                ...
                <img src="./imges/LMS_Logo-removebg-preview.png" alt="" srcset="" class="ms-4" style="width: 13%;">
            </div>
                            ...
                            <div class="p-3 py-3">
                                <div class="d-flex justify-content-between align-items-center mb-5">
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-6 col-12 mb-4">
                                        <label for="username"style="color: #a4a4a4; font-weight: 500;">Username :</label>
                                        <span class="ms-3">${employee.username}</span>
                                    </div>
                                    <div class="col-md-6 col-12 mb-4">
