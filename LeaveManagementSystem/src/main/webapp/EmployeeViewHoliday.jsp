                    ...
                    <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 " style="background-color: rgba(0, 0, 0, 0.2);">
                        <div
                            ...
                            <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start"
                                id="menu">
                                <li>
                                    <a href="EmployeeDashboard?id=<c:out value=" ${employee.id }" />" class="nav-link
                                    align-middle px-0">
                                ...
                                <li>
                                    <a href="EmployeeApplyLeave?id=<c:out value=" ${employee.id }" />" class="nav-link
                                ...
                                <li>
                                    <a href="EmployeeLeaveTracker?id=<c:out value=" ${employee.id }" />" class="nav-link
                                    px-0 mt-2 align-middle">
